...
<body>
<p>This experiment uses [PROPORTIONAL] payouts.</p>
...
$(document).ready(function(){
	...
	$("#continue").click(function(){
		...
		//alert("clicked");
		$.getScript(<?php echo '"' . site_url('seqsim/instructions_wait/'.$treatment_id) . '"';?>);
...
function check_wait(){
	...
	$.getScript(<?php echo '"' . site_url('seqsim/waitjs/instructions/' . $treatment_id) . '"';?>);
}
</script>
</body>
</html>