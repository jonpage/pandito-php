...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('button.no_button').click(function(){
			$('.header_spacer:first').load(<?php echo "'" . site_url('seqsim/send_vote/' . $treatment_id) . "/no'"?>);
		});
		$('button.yes_button').click(function(){
			$('.header_spacer:first').load(<?php echo "'" . site_url('seqsim/send_vote/' . $treatment_id) . "/yes'"?>);
		});
	});
</script>
