...
<?php // var_dump($json['charcolors']); 
echo '<div class="mini_badge header_badge style_' . $json['charcolors'][$agent_num] . '">' . ($agent_num+1); ?></div>
...
function check_wait(){
	$.getScript(<?php echo '"' . site_url('seqsimchareq/waitjs/vote/' . $treatment_id) . '"'; ?>);
}
</script>
