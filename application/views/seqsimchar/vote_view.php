...
<script type="text/javascript">
	var t;
	function check_wait(){
		$.getScript(<?php echo '"' . site_url('seqsimchar/timerjs/' . $treatment_id) . '"'; ?>);
	}
	...
	$(document).ready(function(){
		...
		$('button.no_button').click(function(){
			$('.header_spacer:first').load(<?php echo "'" . site_url('seqsimchar/send_vote/' . $treatment_id) . "/no'"?>);
		});
		$('button.yes_button').click(function(){
			$('.header_spacer:first').load(<?php echo "'" . site_url('seqsimchar/send_vote/' . $treatment_id) . "/yes'"?>);
		});
	});
</script>
