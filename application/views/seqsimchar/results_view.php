...
<script type="text/javascript">
	...
	// animate hovering over a button
		...
		$('button.continue_button').click(function(){
			<?php echo 'window.location = "' . site_url('seqsimchar/results_wait/' . $treatment_id) . '";';?>
			//$('.header_spacer:first').load(<?php echo "'" . site_url('seqsimchar/results_wait/' . $treatment_id . "'");?>);
		});

		$('button.review_button').click(function(){
			<?php echo 'window.location = "' . site_url('seqsimchar/review/' . $treatment_id) . '";';?>
		});
});
</script>
</body>
