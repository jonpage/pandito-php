...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('.clicker div.agent_badge').click(function(){
			...
			$('.right_col').load(<?php echo "'" . site_url('seqsimchar/show_new_groups/' . $session_id . "/'"); ?>+id);
		...
		$('button').click(function(){
			...
			$('.suggestion_selected').load( <?php echo "'" . site_url('seqsimchar/send_proposal') . "/$treatment_id/'"; ?> + $('.suggestion_selected').attr('id'));
		});
