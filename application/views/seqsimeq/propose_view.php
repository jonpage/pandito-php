...
<div class="mini_badge current_player header_badge"><?php echo ($json['proposer']+1); ?></div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('.clicker div.agent_badge').click(function(){
			...
			$('.right_col').load(<?php echo "'" . site_url('seqsimeq/show_new_groups/' . $session_id . "/'"); ?>+id);
		...
		$('button').click(function(){
			...
			$('.suggestion_selected').load( <?php echo "'" . site_url('seqsimeq/send_proposal') . "/$treatment_id/'"; ?> + $('.suggestion_selected').attr('id'));
		});
