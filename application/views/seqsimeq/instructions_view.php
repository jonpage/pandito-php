...
$(document).ready(function(){
	...
	$("#continue").click(function(){
		...
		//alert("clicked");
		$.getScript(<?php echo '"' . site_url('seqsimeq/instructions_wait/'.$treatment_id) . '"';?>);
		//.fail(function(){alert("did not work");});
		//$('#message').load(<?php echo '"' . site_url('seqsimeq/instructions_wait/'.$treatment_id) . '"';?>);
...
function check_wait(){
	...
	$.getScript(<?php echo '"' . site_url('seqsimeq/waitjs/instructions/' . $treatment_id) . '"';?>);
}
</script>
</body>
</html>